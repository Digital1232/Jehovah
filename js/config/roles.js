...
const ROLE_CONFIG = {
    MD: {
        ...
        shortLabel: "MD",
        description: "Full access to all branches, reports, and system settings",
        branchScope: "GLOBAL",
    ...
    HEAD_OFFICE_ADMIN: {
        ...
        shortLabel: "HO Admin",
        description: "Full operational control across all branches",
        branchScope: "GLOBAL",
    ...
    ENQUIRY: {
        ...
        description: "Creates new enquiries; system auto-assigns branch/TL/ASM",
        branchScope: "ASSIGNED",
        department: "Intake & Auto-Assignment",
        dashboard: "enquiry",
    ...
    TL: {
        ...
        description: "Views and manages assigned leads for their own branch only",
        branchScope: "BRANCH",
    ...
    ASM: {
        ...
        shortLabel: "ASM",
        description: "Manages follow-ups, meetings, and lead status for their own branch",
        branchScope: "BRANCH",
    ...
    BM: {
        ...
        description: "Full visibility of their own branch's performance",
        branchScope: "BRANCH",
    ...
    ACCOUNTS: {
        ...
        label: "Accounts Team",
        shortLabel: "Accounts",
        description: "Access to job cards, payments, invoices, and balances (cross-branch)",
    ...
    PROJECT: {
        id: "PROJECT",
        label: "Project Team (future phase)",
        shortLabel: "Project Team",
        description: "Access granted only after project/job card confirmation",
        branchScope: "PROJECT",
    ...
    MAIN_ADMIN: {
        ...
        description: "Primary System Administrator with full security and audit access",
        branchScope: "GLOBAL",
    ...
    SECOND_ADMIN: {
        ...
        description: "Delegated operational administrator with quotation approval rights",
        branchScope: "GLOBAL",
    ...
    MO: {
        ...
        shortLabel: "MO",
        description: "Campaign intake and marketing channel lead performance tracker",
        branchScope: "ASSIGNED",
    ...
    REAL_ESTATE: {
        ...
        description: "Specialized service view for real estate and land deal pipeline",
        branchScope: "SERVICE",
    ...
    INTERIOR: {
        ...
        description: "Specialized service view for interior fitout and design pipeline",
        branchScope: "SERVICE",
    ...
    A_GRADE_MO: {
        ...
        description: "Package configuration manager with full section editing privileges",
        branchScope: "ASSIGNED",
    ...
    D_GRADE_MO: {
        ...
        description: "Marketing officer with restricted package modification rights",
        branchScope: "ASSIGNED",
        department: "Marketing",
...
const NAVIGATION = [
    ...
    { id: "new-enquiry", label: "New Enquiry", icon: "plus-circle", group: "WORKSPACE", roles: ["MD", "HEAD_OFFICE_ADMIN", "MAIN_ADMIN", "ENQUIRY"] },
    ...
    { id: "approvals", label: "Approval Queue", icon: "badge-check", group: "CONTROL", roles: ["MD", "HEAD_OFFICE_ADMIN", "MAIN_ADMIN", "SECOND_ADMIN", "PROJECT"] },
    ...
    { id: "users", label: "User Management", icon: "users", group: "ADMINISTRATION", roles: ["MD", "HEAD_OFFICE_ADMIN", "MAIN_ADMIN"] },
    { id: "branches", label: "Branch Management", icon: "building", group: "ADMINISTRATION", roles: ["MD", "HEAD_OFFICE_ADMIN", "MAIN_ADMIN"] },
    { id: "roles", label: "Roles & Permissions", icon: "shield-check", group: "ADMINISTRATION", roles: ["MD", "HEAD_OFFICE_ADMIN", "MAIN_ADMIN"] },
    { id: "security", label: "Security & Devices", icon: "scan-face", group: "ADMINISTRATION", roles: ["MD", "HEAD_OFFICE_ADMIN", "MAIN_ADMIN", "SECOND_ADMIN"] },
